...
open class BlockType(val color: Int, val id: Short, val texId: Int = id.toInt()) {
    ...
    companion object {
        ...
        val Air = BlockType(0, 0, -1)
        val Stone = BlockType(black or 0x778899, 1, 48)
        val Grass = BlockType(black or 0x55aa33, 2, 226)
        val Dirt = BlockType(black or 0x997755, 3, 112)
        val Water = BlockType(black or 0x3344ff, 4)
        val Lava = BlockType(black or 0xd97520, 5)
        val Log = BlockType(black or 0x835127, 6, 189)
        val Leaves = BlockType(black or 0x187423, 7, 240)
        val Sand = BlockType(black or 0xeddc9e, 8)
        val Sandstone = BlockType(black or 0x9f946b, 9, 185)
